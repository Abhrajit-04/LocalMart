...
function HeroSection() {
    const slides=[
        {
            ...
            btnText: "Shop Now",
            bg:"https://plus.unsplash.com/premium_photo-1663012860167-220d9d9c8aca?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id:2,
            ...
            btnText: "Order Now",
            bg:"https://plus.unsplash.com/premium_photo-1682144120790-1461fd602bc9?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id: 3,
            ...
            btnText: "Get Started",
            bg:"https://plus.unsplash.com/premium_photo-1663126803298-5ca9b4ac1e02?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
    ]
  ...
  return (
    <div className='relative w-[98%] mx-auto mt-32 h-[60vh] sm:h-[70vh] md:h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
        ...
        {/* Content */}
        <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6 pb-24'>
            <motion.div
                initial={{y:30,opacity:0}}
                animate={{y:0,opacity:1}}
                transition={{duration:0.6,delay:0.3}}
                className='flex flex-col items-center justify-center gap-5 max-w-3xl'
            >
