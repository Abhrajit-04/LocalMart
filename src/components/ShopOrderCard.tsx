...
import { ChevronDown, ChevronUp, CreditCard, MapPin, Package, Phone, Truck, User2, UserCheck2 } from 'lucide-react'
...
function ShopOrderCard({ order }: { order: IOrder }) {
    ...
    >
        <div className='flex flex-col md:flex-row md:items-start md:justify-between gap-4'>
            <div className='space-y-1'>
                ...
                <div className='top-3 space-y-1 text-gray-700 text-sm'>
                            ...
                            className='overflow-hidden'>
                                <div className='mt-3 space-y-3'>
                                    {order.items.map((item,index)=>(
                                        <div 
                                        key={index}
                                        className='flex justify-between items-center bg-gray-200 rounded-xl px-3 py-2 hover:bg-gray-300 transition'>
                                            <div className='flex items-center gap-3'>
                                                ...
                                                <div>
                                                    ...
                                                    <p className='text-xs text-gray-600'>{item.quantity} x {item.unit}</p>
                                                </div>
                                            </div>
