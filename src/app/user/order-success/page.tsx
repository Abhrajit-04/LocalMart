  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 text-center bg-linear-to-b from-green-50 to-white'>
        ...
        className='text-gray-600 mt-3 text-sm md:text-base max-w-md'>
            ...
            Processed.You can track its in your <span className='font-semibold text-green-700'>My Orders</span> section.
        </motion.p>
        <motion.div
        ...
        className='mt-10'
        >
            <PackageCheck className='w-16 h-16 md:h-20 md:w-20 text-green-500'/>
        </motion.div>
        <motion.div
        ...
        >
            ...
            >
                ...
                <div className='absolute top-24 left-[30%] w-2 h-2 bg-green-400 rounded-full animate-pulse'/>
                <div className='absolute top-14 left-[50%] w-2 h-2 bg-green-400 rounded-full animate-bounce'/>
